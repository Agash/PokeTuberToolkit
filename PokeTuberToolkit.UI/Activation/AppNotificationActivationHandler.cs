...
public class AppNotificationActivationHandler : ActivationHandler<LaunchActivatedEventArgs>
{
    ...
    protected async override Task HandleInternalAsync(LaunchActivatedEventArgs args)
    {
        ...
        _ = App.MainWindow.DispatcherQueue.TryEnqueue(DispatcherQueuePriority.Low, () =>
        {
            _ = App.MainWindow.ShowMessageDialogAsync("TODO: Handle notification activations.", "Notification Activation");
        });
