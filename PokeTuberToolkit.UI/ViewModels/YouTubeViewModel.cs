...
public partial class YouTubeViewModel(IWebViewService webViewService) : ObservableRecipient, INavigationAware
{
    ...
    private async Task OpenInBrowser()
    {
        ...
        {
            _ = await Windows.System.Launcher.LaunchUriAsync(WebViewService.Source);
        }
    }
