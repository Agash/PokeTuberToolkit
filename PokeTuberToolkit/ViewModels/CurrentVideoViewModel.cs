...
using PokeTuberToolkit.Contracts.ViewModels;
...
public partial class CurrentVideoViewModel : ObservableRecipient, INavigationAware
{
    ...
    public CurrentVideoViewModel(IWebViewService webViewService)
    {
